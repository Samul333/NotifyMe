...
public class CSITfrag extends Fragment implements ProCsitAdapter.onNoteClick {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      DatabaseReference dbProduct = FirebaseDatabase.getInstance().getReference("CSIT");
